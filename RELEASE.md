...
[Versioned documentation](https://prometheus.io/docs/prometheus/latest/getting_started/) gets updated automatically when new tags are published, nothing needs to be done here.
